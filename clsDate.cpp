...
public:
	...
	static short CalculateAgeInMonths(clsDate DateofBirth) {

		clsDate Today = clsDate::GetSystemDate();

		//Fourmula Says=> Months=(Y2​−Y1​)×12+(M2​−M1​);
	...
	static short CalculateAgeInYears(clsDate DateOfBirth)
	{
		clsDate Today = clsDate::GetSystemDate();

		//Age = Y1(Tody.Year) - Y2(DateofBirth.Year);
		short Age = Today.Year - DateOfBirth.Year;
